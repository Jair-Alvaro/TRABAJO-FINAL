...
<style>
    ...
    /* ul {-webkit-transform:scale(1.3);transform:scale(1.3);}
    ul {overflow:hidden;} */
...
<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
      ...
      <img class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" src="https://casadelpoeta.es/wp-content/uploads/2019/09/Hoteles-con-encanto-en-Espa%C3%B1a.jpg" />
        ...
        <div class="container">
          <div class="carousel-caption text-start">
            ...
            <p>Siempre pensamos en ustedes.</p>
          </div>
        </div>
      </div>
      ...
      <img class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" src="https://4kwallpapers.com/images/wallpapers/swimming-pool-spa-hotel-blue-water-reflections-peaceful-3440x1440-2595.jpg" />
        ...
        <div class="container">
          <div class="carousel-caption">
            ...
            <p>La mejor calidad que existe</p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
  ...
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 py-3">
        <h2 class="display-5">Tu lugar cómodo</h2>
        <p class="lead">información de habitaciones</p>
      </div>
      <div class="bg-light shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;"><img src="https://images.unsplash.com/photo-1611892440504-42a792e24d32?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8aG90ZWwlMjByb29tfGVufDB8fDB8fA%3D%3D&w=1000&q=80" alt="auto" width="100%" height="100%"></div>
      <br>
      <p><a class="btn btn-lg btn-primary" href="{{ url('/habitacion') }}">Habitaciones</a></p>
    </div>
    <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 p-3">
        <h2 class="display-5">Nuestros Clientes</h2>
        <p class="lead">información de Clientes</p>
      </div>
      <div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;"><img src="https://mediterrani.com/wp-content/uploads/2020/04/Atencio%CC%81n-cliente-hotel.jpg" alt="auto" width="100%" height="100%"></div>
      <br>
      <p><a class="btn btn-lg btn-primary" href="{{ url('/crudHuesped') }}">Clientes</a></p>
    </div>
  </div>
