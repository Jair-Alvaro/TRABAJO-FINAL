        ...
        <ul class="navbar-nav ms-auto">
                  ...
                  @guest
                      ...
                      <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                              ...
                              <a href="{{ route('login') }}" > <button type="button" class="btn btn-primary"> Iniciar sesion</button></a>
                         
                      
                            @if (Route::has('register'))
                                
                                    <!--<a class="nav-link" href="{{ route('register') }}">{{ __('Register') }}</a>-->
                                    <a href="{{ route('register') }}" > <button type="button" class="btn btn-primary"> Registrate</button></a>
...
<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 py-3">
        <h2 class="display-5">Reservas</h2>
        <p class="lead"></p>
      </div>
    ...
    <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 p-3">
        <h2 class="display-5">Lugares</h2>
        <p class="lead"></p>
      </div>
      
      <div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;"><img src="https://i0.wp.com/aercaribe.com/wp-content/uploads/2020/11/rutas-peru2.png?resize=800%2C800&ssl=1" alt="auto" width="100%" height="100%"></div>
    </div>
  </div>
